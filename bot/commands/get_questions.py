...
async def menu_get_questions(call: types.CallbackQuery, callback_data: PostCD, session_maker: sessionmaker) -> None:
    """
    ...
    question: Post = await get_post(post_id=callback_data.post_id, session_maker=session_maker)
